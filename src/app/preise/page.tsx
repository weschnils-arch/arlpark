        ...
        <main className="bg-slate-50 min-h-screen">
            ...
            >
                <div
                    ...
                    style={{
                        backgroundImage: `url('/images/activities/Bowling/DSC2180-scaled.jpg')`,
                ...
                <div className="relative z-20 text-center text-white px-4 max-w-4xl mx-auto">
                    ...
                    <p className="text-xl md:text-2xl font-light drop-shadow-md text-white/90 max-w-2xl mx-auto">Faire Preise für unvergessliche Erlebnisse.</p>
                </div>
            </section>
