        ...
        <main className="bg-white min-h-screen">
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 bg-slate-300 flex items-center justify-center">
                    <span className="text-4xl text-white/50 font-bold">Foto: Bowlingbahn</span>
                </div>

                <div className="relative z-20 text-center text-white px-4">
                    <div className="w-20 h-20 bg-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl">
                        <BowlingIcon size={40} />
                    </div>
                    <h1 className="text-5xl md:text-7xl font-black mb-6">Bowling</h1>
                    <p className="text-xl md:text-2xl font-light max-w-2xl mx-auto">
                        Strike! 4 vollautomatische Bahnen für Spaß mit Freunden und Familie.
                    </p>
                </div>
            </section>
