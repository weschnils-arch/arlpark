        ...
        <main className="bg-white min-h-screen">
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 bg-slate-300 flex items-center justify-center">
                    <span className="text-4xl text-white/50 font-bold">Foto: Gruppe/Schulklasse</span>
                </div>

                <div className="relative z-20 text-center text-white px-4">
                    <h1 className="text-5xl md:text-7xl font-black mb-6">Gruppen & Vereine</h1>
                    <p className="text-xl md:text-2xl font-light max-w-2xl mx-auto">
                        Gemeinsam Action erleben. Ideal für Schulausflüge, Vereine und Teambuilding.
                    </p>
                </div>
            </section>
